---
title: Entity — Update entity information
description: Update information for a specific entity.
---

# Update entity information

Updates information for a specific entity.

## Endpoint

```http
PATCH /companies/{company-id}/entities/{entityID}
```
...
{
  "general": {
    // Complex object with personal/company info
  }
}
```
...
|----------|------|----------|-------------|
| `general` | object | Yes | General information to update for the entity |
