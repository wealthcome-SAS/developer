import { Card as DesignCard, CardContent, CardDescription, CardTitle } from 'design-system'
import { Building, Users, User, ExternalLink, Settings, TrendingUp, Database, FileText } from 'lucide-react'
...
export function Card({ title, description, href, icon, variant = 'doc' }: CardProps) {
